        ...
        <footer style={{ 
            ...
            <div className="footer-container" style={{
                ...
                <div className="social-icons" style={{ flex: '1 1 auto', justifyContent: 'center' }}>
                    ...
                    <a href="https://www.instagram.com/forsa.platform?igsh=aDNsMWd6cXhrY2hy" target="_blank" rel="noopener noreferrer" aria-label="Instagram"><i className="fab fa-instagram"></i></a>
